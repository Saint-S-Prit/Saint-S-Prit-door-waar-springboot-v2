...
import com.espritech.workerExpress221.config.exception.InvalidOperationException;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  public ResponseEntity<ErrorDto> handleException(FileSizeLimitExceededException exception, WebRequest webRequest) {
    final HttpStatus badRequest = HttpStatus.BAD_REQUEST;
